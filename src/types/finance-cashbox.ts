...
export interface TokenBag {
  ...
  profitability_surplus_usd:number;
  profitability_surplus_total_usd:number;
  provider_profitability_credit_usd:number;
...
export interface BagGeneration {execution_id:string;tokens_used:number;created_at:string;infrastructure_cost_usd:number;company_profit_usd:number;profitability_surplus_usd:number;rounding_surplus_usd:number;status?:string|null}
