...
export type GenerationExecutionOrigin = "appweb" | "backoffice" | "admin" | "api" | "system";
export interface GenerationBillingBreakdown extends Record<string, unknown> {
