        ...
        <section className="luxia-panel mt-5 rounded-3xl p-6">
          ...
          <div className="mt-5 rounded-2xl border border-white/7 bg-black/20 p-5">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <NumberField label="Concurrencia por contenedor" description="Para workflows pesados se recomienda 1 trabajo simultáneo por GPU." value={draft.modal_concurrency} max={16} onChange={(v) => update("modal_concurrency", v)} />
