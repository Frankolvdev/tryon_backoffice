...
function friendlyEngine(engine:string){return engine==="runpod_serverless"?"RunPod":engine==="local_docker"?"Docker Local":engine==="owner_local"?"Owner Local":engine==="modal"?"Modal":engine==="beam"?"Beam":engine==="simulated"?"Simulado":engine}
